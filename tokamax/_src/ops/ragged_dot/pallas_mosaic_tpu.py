...
GMM_TILING_TUNED_LUT: dict[LUTKey, LUTValue] = {
    ...
    (524288, 7168, 2048, 256, False): ((256, 7168, 512), 2),
    (524288, 7168, 2048, 256, True): ((128, 7168, 2048), 2),
    (524288, 2048, 7168, 256, False): ((128, 2048, 3584), 2),
    (524288, 2048, 7168, 256, True): ((256, 2048, 3584), 3),
}
GMM_RHS_TRANSPOSE_TILING_TUNED_LUT: dict[LUTKey, LUTValue] = {
    ...
    (524288, 7168, 2048, 256, False): ((256, 2048, 1792), 2),
    (524288, 7168, 2048, 256, True): ((256, 2048, 3584), 2),
    (524288, 2048, 7168, 256, False): ((256, 7168, 512), 2),
    (524288, 2048, 7168, 256, True): ((256, 7168, 1024), 2),
}
TGMM_TILING_TUNED_LUT: dict[LUTKey, LUTValue] = {
    ...
    (524288, 7168, 2048, 256, False): ((512, 1024, 2048), 3),
    (524288, 7168, 2048, 256, True): ((512, 1024, 2048), 2),
    (524288, 2048, 7168, 256, False): ((256, 2048, 1024), 3),
    (524288, 2048, 7168, 256, True): ((512, 512, 3584), 2),
}
